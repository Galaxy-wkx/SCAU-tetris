...
public class GameDataStructure {
	...
	public static final Color[] allColor = new Color[] {Color.BLUE, Color.RED, Color.GREEN,  
	Color.ORANGE, Color.YELLOW, Color.CYAN, Color.PINK};
	...
	public static int getRandomFlat() {
		Random random = new Random();
		return 1+random.nextInt(GameAttributions.gameColumns - 5);
	}
	
	public static Color getRandomColor() {
		Random random = new Random();
		// 随机数范围是在定义的生成池数组的长度之内
		int randomIndex = random.nextInt(allColor.length);
		return allColor[randomIndex];
	}
